...
$emp= mysqli_query($link, "select * from emp_details where id=$id"); 
...
if(isset($_POST['upload']))
{
	...
	$file_store= "./files/".$time.$file_name;
	$file_display= "files/".$time.$file_name;
...
{	
		echo '<form style="font-family: corbel" action="admin_emp_update.php" enctype="multipart/form/data" method="POST">';
				
		echo '<input type="hidden" name="id" value="'.$row["id"].'"';
		echo '<p>';
		echo '<div class="left" style="margin-bottom: 50px; margin-top: 50px; font-size: 30px;">PERSONAL DETAILS</div>';
		echo '<div style="float: left; margin-left: 50px">';
		echo '<div class="left">First Name :  <input class="text_button" style="margin-left: 42px" type="text" name="nfname" value="'.$row["fname"].'"></div>';
		echo '<div class="left">Middle Name :  <input class="text_button"  style="margin-left: 25px" type="text" name="nmname" value="'.$row["mname"].'"></div>';
		echo '<div class="left">Last Name :  <input class="text_button" style="margin-left: 43px" type="text" name="nlname" value="'.$row["lname"].'"></div>';
		...
		echo '<div>Image :  <input class="text_button"  style="margin-left: 80px; width: 100px; height: 150px;" type="text" href="'.$row["image"].'"></div>';
		...
		echo '<div class="left">User Name :  <input class="text_button" style="margin-left: 45px" type="text" name="nuname" value="'.$row["uname"].'"></div>';
		...
		echo '<div style="float: left; margin-left: 50px">';
		echo '<div class="left">Employee ID :  <input class="text_button" style="margin-left: 35px; width: 100px" type="number" name="neid" value="'.$row["eid"].'"></div>';
		...
		echo '<div>Salary :  <input class="text_button" style="margin-left: 92px; width: 100px; margin-bottom: 50px" type="number" name="nsal" value="'.$row["salary"].'"></div>';
		echo '</div>';
		
		
		echo '<input name="upload" class="left" type="submit" style="margin-bottom: 130px; margin-left: 55%; width: 150px">';
